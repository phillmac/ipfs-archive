...
func NewAPI(spec *loads.Document) *API {
	return &API{
		...
		IPFSArchiveURLHandler: ipfs.ArchiveURLHandlerFunc(func(params ipfs.ArchiveURLParams) middleware.Responder {
			return middleware.NotImplemented("operation IPFSArchiveURL has not yet been implemented")
		}),
	}
}
...
func (o *API) Validate() error {
	...
	if o.IPFSArchiveURLHandler == nil {
		unregistered = append(unregistered, "ipfs.ArchiveURLHandler")
	}
...
func (o *API) initHandlerCache() {
	...
	o.handlers["POST"]["/archive"] = ipfs.NewArchiveURL(o.context, o.IPFSArchiveURLHandler)
